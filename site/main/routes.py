...
from browardreseller.main.forms import NewItemForm, NewSaleForm, UploadItemForm, UploadRoloForm
from browardreseller.main.utils import save_pictures
from browardreseller.models.item import Item
from browardreseller.models.sale import Sale
# from browardreseller.webhandlers.depop import DepopManager
# from browardreseller.webhandlers.ebay import EbayManager
...
def inv_item (item_id):
    ...
    return render_template('inv_item.html', model=model, form=form)
